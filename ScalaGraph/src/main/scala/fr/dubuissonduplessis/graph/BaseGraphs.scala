...
trait BaseGraphs {
  ...
  /**
   * Type of the graph that is generated by a graph module
   * which specializes this abstract one.
   */
  type GeneratedGraph <: BaseGraph
  ...
  trait BaseGraph {
    ...
    lazy val connectedComponents: List[GeneratedGraph] =
      {
     ...
     */
    def subGraph(nodes: Set[Node]): GeneratedGraph
